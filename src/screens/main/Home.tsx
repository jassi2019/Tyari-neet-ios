  ...
  return (
    ...
    >
      ...
      <ScrollView
        ...
        contentContainerStyle={{ backgroundColor: 'transparent', paddingBottom: 0 }}
...
const styles = StyleSheet.create({
  ...
  heroLeft: { flex: 1 },
  heroRight: { marginLeft: 8 },
  heroTitle: { fontSize: 20, fontWeight: '900', color: '#fff', lineHeight: 26 },
  heroSub: { fontSize: 12, fontWeight: '600', color: '#94a3b8', marginTop: 4 },
  heroBtn: { backgroundColor: '#F5A623', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 12 },
